...
Filter dataset and keep bacteria only
...
input_fasta = "reference_sequences.fna"
...
for line in tax:
    ...
    if identifier_split[0] == "d_Procaryota":
...
count = SeqIO.write(new_aln,"fasta_with_tax_names.fasta", "fasta")
print ("")
print ("Done. Saved %i sequences in the fasta file." %(count,))
print ("")
